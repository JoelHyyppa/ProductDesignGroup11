...
export default function FtD() {
  ...
  return (
    <div>
      ...
      <div><Button onClick={getDeck}>Hae korttipakka</Button></div>
      <h1><Button variant="ftd" onClick={drawCard}>Nosta kortti</Button></h1>
      <p> <Image src={"/"+currentCard+".jpg"} width={239} height={335}/></p>
      <div><Button onClick={getPlayerNames}>Pelaajat</Button></div>
      <button class="accordion">Säännöt</button>
      <div class="panel">
      <li>Jokainen pelaaja nostaa vuorollaan yhden kortin. Alimman kortin nostanut määrätään jakajaksi.</li>
      <li>Ennen pelin alkua jakaja kysyy seuraavalta pelaajalta kortin maata.</li>
      <li>Pelaajan arvatessa oikein jakaja juo 2 ja seuraavan arvaajan vuoro alkaa. Muussa tapauksessa pelaaja juo 2.</li>
      <li>Pelaajan arvatessa väärin tulee hänen seuraavaksi arvata kortin arvoa. Oikein arvatessa pelaajan vuoro loppuu ja jakaja juo 3, muuten pelaaja juo 3.</li>
      <li>Jos pelaaja arvaa taas väärin, hänen tulee arvata nyt, onko kortin arvo edellistä pienempi vai suurempi. Jos pelaaja arvaa oikein, jakaja juo 4, muuten pelaaja juo 4 ja hänestä tulee diileri!</li>
