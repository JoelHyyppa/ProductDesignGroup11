...
const truthOrDare = [
  ...
  {
    truth:
      "Totuus: Ottaisitko mieluummin tosi ruman mutta luonteeltaan täydellisen kumppanin vai vitun kuuman mutta täyden kusipään?",
  },
  ...
  {
    truth:
      "Totuus: Jos saisit käyttää vain yhtä kirosanaa koko loppuelämäsi ajan, mikä se olisi?",
  },
  {
    truth:
      "Totuus: Oletko koskaan käräyttänyt jonkun tai kärähtänyt itse runkkaamisesta?",
  },
  { truth: "Totuus: Kerro oudoimmasta unestasi jonka olet nähnyt" },
  {
    truth:
      "Totuus: Jos voisit syntyä uudestaan jonkun ruumiissa, kuka se olisi?",
  },
]
